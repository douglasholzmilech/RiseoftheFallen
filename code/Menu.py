    ...
    def run(self, ):
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    self.menu_text(20, MENU_OPTION[i], text_color=COLOR_YELLOW, text_center_pos=((WIN_WIDTH / 2), 500 + 30 * i))
                else:
                    self.menu_text(20, MENU_OPTION[i], text_color=COLOR_RED, text_center_pos=((WIN_WIDTH / 2), 500 + 30 * i))
